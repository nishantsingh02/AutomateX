 ...
 * Register a new user
 */
export const apiSignup = async (username: string, password: string): Promise<IdResponse> => {
 ...
 */
export const apiSignin = async (username: string, password: string): Promise<SigninResponse> => {
